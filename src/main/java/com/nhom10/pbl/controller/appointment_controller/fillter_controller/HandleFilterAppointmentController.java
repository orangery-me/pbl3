...
public class HandleFilterAppointmentController {
        ...
        public String getListDoctorOfDepartment(@PathVariable("departmentId") String departmentId,
                ...
                List<DoctorResponse> ListdoctorResponses = _departmentServices.getListDoctor(
        ...
        public String getDetailDoctor(@PathVariable("doctorId") String doctorId, HttpServletRequest request,
                        Model model) {
        ...
        public String getListDoctorOfDepartmentToday(@PathVariable("departmentId") String departmentId,
                ...
                List<DoctorResponse> listDoctorResponeToday = _departmentServices
                                .listDoctorToday(Long.parseLong(departmentId));
                List<DoctorResponse> searchByName = _departmentServices.searchByNameDoctor(listDoctorResponeToday,
                                doctorName);
                List<DoctorResponse> finaListDoctor = _departmentServices.filterDoctorByGenderAndShift(searchByName,
                                gender, shift, "today");
        ...
        public String getListDoctorOfDepartmentTomorrow(@PathVariable("departmentId") String departmentId,
                ...
                List<DoctorResponse> listDoctorResponeTomorrow = _departmentServices
                                .listDoctorTomorrow(Long.parseLong(departmentId));
                List<DoctorResponse> searchByName = _departmentServices.searchByNameDoctor(listDoctorResponeTomorrow,
                                doctorName);
        ...
        public String getListDoctorOfDepartmentNextSevenDay(@PathVariable("departmentId") String departmentId,
                ...
                List<DoctorResponse> listDoctorResponeNextSevenDay = _departmentServices
                                .listDoctorNextSevenDay(Long.parseLong(departmentId));
                List<DoctorResponse> searchByName = _departmentServices.searchByNameDoctor(
                                listDoctorResponeNextSevenDay,
                                doctorName);
                List<DoctorResponse> finaListDoctor = _departmentServices.filterDoctorByGenderAndShift(searchByName,
                                gender,
                                shift, "nextseven");
        ...
        public String getListDoctorOfDepartmentByName(@PathVariable("departmentId") String departmentId,
                ...
                List<DoctorResponse> listDoctorRespone = _departmentServices.getListDoctor(Long.parseLong(departmentId),
                                true);
                List<DoctorResponse> searchByName = _departmentServices.searchByNameDoctor(listDoctorRespone,
                                doctorName);
                List<DoctorResponse> finaListDoctor = _departmentServices.filterDoctorByGenderAndShift(searchByName,
                                gender, shift, "none");
                model.addAttribute("listDoctorOfDepartment", finaListDoctor);
