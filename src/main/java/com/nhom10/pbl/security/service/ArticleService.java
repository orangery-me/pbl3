...
//    }
    ...
    private ArticleResponse mapToArticleResponseWithImage(Article article) { //để trích xuất URL của hình ảnh đầu tiên từ nội dung bài viết
        // và cập nhật content của ArticleResponse thành URL của hình ảnh đầu tiên để hiển thị trước khi người dùng click vào bài viết để xem chi tiết
